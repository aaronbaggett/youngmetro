...
\setbeamertemplate{headline}{
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=.5ex,center,dp=.5ex]{sthlmLightGrey}%
...
\setbeamertemplate{frametitle}
{
\begin{beamercolorbox}[sep=1.375ex,wd=\paperwidth,leftskip=0.075cm,rightskip=0.3cm,ht=2.75ex,dp=1.375ex]{frametitle}
...
\setbeamertemplate{footline}
{
  \leavevmode%
  \hbox{%
  \begin{beamercolorbox}[sep=1ex,wd=.333333\paperwidth,ht=2.25ex,dp=1ex,left]{author in head/foot}%
    \usebeamerfont{author in head/foot}\insertshortauthor\expandafter\beamer@ifempty\expandafter{\beamer@shortinstitute}{}{~~(\insertshortinstitute)}
  \end{beamercolorbox}%
  \begin{beamercolorbox}[sep=1ex,wd=.333333\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \usebeamerfont{title in head/foot}\insertshorttitle
  \end{beamercolorbox}%
  \begin{beamercolorbox}[sep=1ex,wd=.333333\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
